...
export const employeeSchema = z.object({
  body: z.object({
    ...
    email: z
      ...
      .trim(),
    store: z
      .string({ required_error: 'يجب ان ينتمي الموظف الى  متجر' })
...
export const updateEmployeeSchema = z.object({
  body: z.object({
    name: z.string({}).nonempty(' اسم الموظف مطلوب').trim().optional(),
    password: z
      .string()
      .nonempty('كلمة السر مطلوب')
      .min(6, 'كلمة المرور قصيرة جدًا - يجب أن تحتوي على 6 أحرف على الأقل')
      .optional(),
    email: z
      .string({})
      ...
      .trim()
      .optional(),
    store: z.string().nonempty('يجب ان ينتمي الموظف الى  متجر').optional(),
    address: z.string().nonempty('العنوان مطلوب').optional(),
  }),
})
