...
abstract class $UserLoginCopyWith<$Res> {
  ...
  @useResult
  $Res call({String status, String token, Data data});
...
class _$_UserLogin with DiagnosticableTreeMixin implements _UserLogin {
  _$_UserLogin({required this.status, required this.token, required this.data});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserLogin(status: $status, token: $token, data: $data)';
  }
...
abstract class _UserLogin implements UserLogin {
  factory _UserLogin(
      ...
      required final Data data}) = _$_UserLogin;
...
abstract class _Data implements Data {
  factory _Data({required final User user}) = _$_Data;
...
class _$_User with DiagnosticableTreeMixin implements _User {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'User(name: $name, email: $email, photo: $photo, role: $role, createdAt: $createdAt, updatedAt: $updatedAt, id: $id)';
  }
