...
import 'package:warehouse/features/employee/data/model/employee_model/employee_model.dart';
...
class EmployeeProfileWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          di.getIt<EmployeeBloc>()..add(const EmployeeEvent.getMyProfileEvent()),
  ...
  Widget _buildMyProfile(BuildContext context, EmployeeModel model) =>
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                      child: Text(
                    textDirection: TextDirection.rtl,
                    ChoseDateTime().chose(model.createdAt),
                    style: Theme.of(context).textTheme.bodyMedium,
                  )),
                ],
              ),
